...
Free cooling can be turned on or off from flows with the "Turn free cooling on" and "Turn free cooling off" actions, for example to allow it in summer only. The unit still decides when free cooling actually runs, based on its extract temperature setpoint and outdoor temperature limit in the device settings. Both of those can also be changed from flows with the "Set free cooling setpoint" and "Set free cooling outdoor temperature limit" actions.
